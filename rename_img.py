...
_STRIP_PATTERNS = [
    ...
    re.compile(
        r"\b[a-f0-9]{4}-[a-f0-9]{4,12}\b", re.IGNORECASE
    ),  # UUID fragments like 2c8d-c4a04fee26cb
    re.compile(
        r"\b[a-f0-9]{8,}\b", re.IGNORECASE
    ),  # long hex/hash (catches 8+ chars including c4a04fee26cb)
